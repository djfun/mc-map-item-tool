...
function load_colors(new_colors) {
  ...
  if (new_colors == 'no') {
    ...
    minecraftcolors = [
      ...
      new Colour(Colour.RGBA, [37, 22, 16, 255]),
      new Colour(Colour.RGBA, [20, 12, 8, 255]),
      new Colour(Colour.RGBA, [133, 34, 35, 255]),
      new Colour(Colour.RGBA, [163, 41, 42, 255]),
      new Colour(Colour.RGBA, [189, 48, 49, 255]),
      new Colour(Colour.RGBA, [100, 25, 26, 255]),
      new Colour(Colour.RGBA, [104, 44, 68, 255]),
      new Colour(Colour.RGBA, [128, 54, 84, 255]),
      new Colour(Colour.RGBA, [148, 63, 97, 255]),
      new Colour(Colour.RGBA, [78, 33, 51, 255]),
      new Colour(Colour.RGBA, [65, 18, 20, 255]),
      new Colour(Colour.RGBA, [79, 22, 25, 255]),
      new Colour(Colour.RGBA, [92, 25, 29, 255]),
      new Colour(Colour.RGBA, [49, 13, 15, 255]),
      new Colour(Colour.RGBA, [16, 89, 95, 255]),
      new Colour(Colour.RGBA, [19, 109, 116, 255]),
      new Colour(Colour.RGBA, [22, 126, 134, 255]),
      new Colour(Colour.RGBA, [12, 67, 71, 255]),
      new Colour(Colour.RGBA, [41, 100, 99, 255]),
      new Colour(Colour.RGBA, [50, 123, 121, 255]),
      new Colour(Colour.RGBA, [58, 142, 140, 255]),
      new Colour(Colour.RGBA, [31, 75, 74, 255]),
      new Colour(Colour.RGBA, [61, 31, 44, 255]),
      new Colour(Colour.RGBA, [74, 38, 53, 255]),
      new Colour(Colour.RGBA, [86, 44, 62, 255]),
      new Colour(Colour.RGBA, [46, 23, 33, 255]),
      new Colour(Colour.RGBA, [14, 127, 94, 255]),
      new Colour(Colour.RGBA, [17, 155, 115, 255]),
      new Colour(Colour.RGBA, [20, 180, 133, 255]),
      new Colour(Colour.RGBA, [11, 95, 70, 255])
    ];
  } else {
    minecraftcolors = [
      new Colour(Colour.RGBA, [255, 255, 255, 0]),
